...
void kernel(
		...
		stream<ap_int<16> > &stream_o0, stream<ap_int<16> > &stream_o1
		)
{
	ap_int<16> i_0, i_1, i_2, i_3, i_4, i_5, i_6, i_7, i_8, i_9, i_10, i_11, i_12, i_13, i_14;
	ap_int<16> o_0, o_1;
	ap_int<16> t_1, t_2, t_3, t_4, t_5, t_6, t_7, t_8;


	if (!stream_i0.empty() & !stream_i1.empty() & !stream_i2.empty() & !stream_i3.empty() & !stream_i4.empty() & !stream_i5.empty() & !stream_i6.empty() & !stream_i7.empty() & !stream_i8.empty() & !stream_i9.empty() & !stream_i10.empty() & !stream_i11.empty() & !stream_i12.empty() & !stream_i13.empty() & !stream_i14.empty())
	{
		i_0 = stream_i0.read();
		i_1 = stream_i1.read();
		i_2 = stream_i2.read();
